...
3. [Configuration Files](#configuration-files)
   ...
   - [`emails.txt`](#2-emailstxt)
   - [`solanaAddresses.txt`](#3-solanaAddresseststxt)
...
### 2. `emails.txt` - 🗂️ User Data

Fill with your emails address. This file contains user data in the following format:
